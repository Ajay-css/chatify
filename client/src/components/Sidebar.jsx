...
const Sidebar = () => {
    ...
    const filteredUsers = showOnlineOnly ? users.filter((user) => safeOnlineUsers.includes(user._id)) : users;
            ...
            <div className="overflow-y-auto w-full py-3">
                {filteredUsers.map((user) => (
                    <button
                        ...
                        className={`w-full p-3 flex items-center gap-3 hover:bg-base-200 transition-colors ${selectedUser?._id === user._id ? "bg-base-300 ring-2 ring-primary" : ""}`}
                    >
                        {/* Avatar */}
